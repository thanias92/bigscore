...
/* @var $model app\modules\vendorfinance\LaporanSearch */
/* @var $form yii\widgets\ActiveForm */
?>
<div class="collapse show searchBox" id="laporan-search">
...
<div class="col-4">
    <?php // echo $form->field($model, 'pemasukan_id') ?>
</div>
<div class="col-4">
    <?php // echo $form->field($model, 'pengeluaran_id') ?>
</div>
<div class="col-4">
    <?php // echo $form->field($model, 'tanggal') ?>
</div>
<div class="col-4">
    <?php // echo $form->field($model, 'tipe_laporan') ?>
</div>
<div class="col-4">
    <?php // echo $form->field($model, 'jumlah_pemasukan') ?>
</div>
<div class="col-4">
