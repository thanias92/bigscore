...
/* @var $searchModel app\modules\vendorfinance\LaporanSearch */
...
?>
<?php Pjax::begin(['id' => 'gridDatalaporan', 'timeout' => false, 'enablePushState' => true, 'enableReplaceState' => false]); ?>
<div class="card">
  <div class="card-header d-flex">
    ...
    <div class="ms-3">
      <?php // echoHtml::a('<i class="fa fa-search"></i> Cari', '#laporan-search', ['class' => 'btn btn-sm btn-warning', 'data-bs-toggle' => 'collapse' , 'aria-controls' => 'laporan-search']); ?>
      <?=  Html::button('Tambah |
      ...
      </svg>', ['value' => Url::to(['create']), 'title' => 'Form '.Yii::t('app', 'Laporan'), 'class' => 'showModalButton btn btn-primary']); ?>
    </div>
  </div>
  <div class="card-body">
    <div class="laporan-index col-lg-12 p-0 table-responsive">
        ...
        ','#', ['value' => Url::to(['view', 'laporan_id' => $model->laporan_id]), 'title' => 'Detail '.Yii::t('app', 'Laporan'), 'class' => 'showModalButton text-primary me-md-1']).
        Html::a('
        <svg class="icon-16" width="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        ','#', ['value' => Url::to(['update', 'laporan_id' => $model->laporan_id]), 'title' => 'Form Edit '.Yii::t('app', 'Laporan'), 'class' => 'showModalButton text-success me-md-1']).
        Html::a('
        <svg class="icon-16" width="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        ','#',['laporan_id' => $model->laporan_id, 'title' => 'Hapus Data?', 'class' => 'text-danger delete']);
        }
        ],
        ],
        ]); ?>
...
<script>
  ...
  $(document).on("click", ".delete", function() {
    var id = $(this).attr("laporan_id");
    var link_delete = "<?= $link_delete; ?>?laporan_id=" + id;
    Swal.fire({
      title: 'Konfirmasi',
