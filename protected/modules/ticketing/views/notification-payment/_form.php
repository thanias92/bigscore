...
<div class="notification-payment-form">
  ...
  <div class="row">
    <div class="col-4">
    <?= $form->field($model, 'customer_id')->textInput(['class' => 'form-control-sm']) ?>
</div>
<div class="col-4">
    <?= $form->field($model, 'status_payment')->textInput(['maxlength' => true,'class' => 'form-control-sm']) ?>
</div>
<div class="col-4">
    <?= $form->field($model, 'last_notified_at')->textInput(['class' => 'form-control-sm']) ?>
</div>
<div class="col-4">
    <?= $form->field($model, 'late_month_count')->textInput(['class' => 'form-control-sm']) ?>
</div>
<div class="col-4">
