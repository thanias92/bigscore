...
/* @var $model app\modules\ticketing\NotificationContractSearch */
/* @var $form yii\widgets\ActiveForm */
?>
<div class="collapse show searchBox" id="notification-payment-search">
  <div class="notification-payment-search">
    ...
    <div class="row">
      ...
      ?>      
      <div class="col-4">
    <?php // echo $form->field($model, 'id_notification') ?>
</div>
<div class="col-4">
...
<div class="col-4">
    <?php // echo $form->field($model, 'last_notified_at') ?>
</div>
<div class="col-4">
    <?php // echo $form->field($model, 'late_month_count') ?>
</div>
<div class="col-4">
