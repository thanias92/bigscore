...
/* @var $searchModel app\modules\ticketing\NotificationPaymentSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Notification Payment';
...
<div class="card">
  <div class="card-header d-flex">
    <div class="header-title flex-grow-1">
      <h4 class="card-title">Notification Payment</h4>
    </div>
    <div style="width:20%">
                  <?php  echo $this->render('_search', ['model' => $searchModel]); ?>
          </div>
    <div class="ms-3">
      <?php // echoHtml::a('<i class="fa fa-search"></i> Cari', '#notification-payment-search', ['class' => 'btn btn-sm btn-warning', 'data-bs-toggle' => 'collapse' , 'aria-controls' => 'notification-payment-search']); ?>
      <?=  Html::button('Tambah |
      ...
      </svg>', ['value' => Url::to(['create']), 'title' => 'Form '.'Notification Payment', 'class' => 'showModalButton btn btn-primary']); ?>
    </div>
  </div>
  <div class="card-body">
    <div class="notification-payment-index col-lg-12 p-0 table-responsive">
        ...
        ','#', ['value' => Url::to(['view', 'id_notification' => $model->id_notification]), 'title' => 'Detail '.'Notification Payment', 'class' => 'showModalButton text-primary me-md-1']).
        Html::a('
        <svg class="icon-16" width="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        ','#', ['value' => Url::to(['update', 'id_notification' => $model->id_notification]), 'title' => 'Form Edit '.'Notification Payment', 'class' => 'showModalButton text-success me-md-1']).
        Html::a('
        <svg class="icon-16" width="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        ','#',['id_notification' => $model->id_notification, 'title' => 'Hapus Data?', 'class' => 'text-danger delete']);
        }
        ],
        ],
        ]); ?>
