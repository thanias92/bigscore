...
<div class="card">
  <div class="card-header d-flex">
    ...
    <div class="ms-3">
      <?php // echoHtml::a('<i class="fa fa-search"></i> Cari', '#feedback-search', ['class' => 'btn btn-sm btn-warning', 'data-bs-toggle' => 'collapse' , 'aria-controls' => 'feedback-search']); ?>
      <?=  Html::button('Tambah |
      ...
      </svg>', ['value' => Url::to(['create']), 'title' => 'Form '.'Feedback', 'class' => 'showModalButton btn btn-primary']); ?>
    </div>
  </div>
  <div class="card-body">
    <div class="feedback-index col-lg-12 p-0 table-responsive">
        ...
        ','#', ['value' => Url::to(['view', 'id_feedback' => $model->id_feedback]), 'title' => 'Detail '.'Feedback', 'class' => 'showModalButton text-primary me-md-1']).
        Html::a('
        <svg class="icon-16" width="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        ','#', ['value' => Url::to(['update', 'id_feedback' => $model->id_feedback]), 'title' => 'Form Edit '.'Feedback', 'class' => 'showModalButton text-success me-md-1']).
        Html::a('
        <svg class="icon-16" width="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        ','#',['id_feedback' => $model->id_feedback, 'title' => 'Hapus Data?', 'class' => 'text-danger delete']);
        }
        ],
        ],
        ]); ?>
