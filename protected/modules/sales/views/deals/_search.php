...
use kartik\form\ActiveForm; //(test)

/* @var $this yii\web\View */
/* @var $model app\modules\sales\DealsSearch */
/* @var $form yii\widgets\ActiveForm */
?>
<div class="collapse show searchBox" id="deals-search">
...
<div class="col-4">
    <?php // echo $form->field($model, 'label_deals') ?>
</div>
<div class="col-4">
