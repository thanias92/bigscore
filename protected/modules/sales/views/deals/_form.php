...
<script>
  ...
  $('#deals-label_deals').on('change', function() {
    ...
    // === LOGIKA BARU: Isi tanggal otomatis ===
    const labelValue = $(this).val();
    const purchaseDateField = $('#deals-purchase_date');

    // Jika label diubah menjadi 'Deal Won' dan field tanggal masih kosong
    if (labelValue === 'Deal Won' && purchaseDateField.val() === '') {
      ...
      // Atur nilai field tanggal menjadi tanggal hari ini
      purchaseDateField.val(formattedDate);
    }
  });
