...
/* @var $model app\modules\sales\CustomerSearch */
/* @var $form yii\widgets\ActiveForm */
?>
<div class="collapse show searchBox" id="customer-search">
...
<div class="col-4">
    <?php // echo $form->field($model, 'customer_website') ?>
</div>
<div class="col-4">
    <?php // echo $form->field($model, 'establishment_date') ?>
</div>
<div class="col-4">
...
<div class="col-4">
    <?php // echo $form->field($model, 'pic_workroles') ?>
</div>
<div class="col-4">
