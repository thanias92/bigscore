...
<div class="task-form">
  ...
  <div class="row">
    <div class="col-md-6">
      <?= $form->field($model, 'label_task')->widget(Select2::class, [
        'data' => ['Bug' => 'Bug', 'Fitur' => 'Fitur', 'Dokumentasi' => 'Dokumentasi', 'Feature Request' => 'Feature Request'],
        'options' => [
    ...
    <div class="col-md-6">
      <?= $form->field($model, 'modul')->textInput(['required' => true])->dropDownList(['Pendaftaran' => 'Pendaftaran', 'Obat' => 'Obat', 'Dokter' => 'Dokter', 'Farmasi' => 'Farmasi'], ['options' => [$model->modul => ['Selected' => true]]]) ?>
    </div>
  </div>
  ...
  <div>
    <?= $form->field($model, 'assign')->textInput(['required' => true])->dropDownList(['Pasman Rizky' => 'Pasman Rizky', 'Yuliana Putri' => 'Yuliana Putri', 'Nanang Sunardi' => 'Nanang Sunardi', 'Agung Sucipto' => 'Agung Sucipto', ' Iwan Mardiansyah' => 'Iwan Mardiansyah'], ['options' => [$model->assign => ['Selected' => true]]]) ?>
  </div>
  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <?= $form->field($model, 'finishdate_task')->textInput([
            'type' => 'date',
            'required' => false,
            'value' => ($model->status == 'Merge' && !empty($model->finishdate_task))
              ? date('Y-m-d', strtotime($model->finishdate_task))
              : ''
          ])->label(false) ?>
        </div>
    ...
    <div class="col-md-6">
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          if ($jumlahTask == true && $model->status == "Open") {
            unset($statusList['In Progress']);
            unset($statusList['Done']);
            unset($statusList['Merge']);
          }
          ?>
