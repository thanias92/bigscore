...
class Generator extends \yii\gii\Generator
{
  ...
  public function generateActiveField($attribute)
  {
    ...
    if ($column->phpType !== 'string' || $column->size === null) {
      return "\$form->field(\$model, '$attribute')->$input(['class' => 'form-control-sm'])";
    }

    return "\$form->field(\$model, '$attribute')->$input(['maxlength' => true,'class' => 'form-control-sm'])";
  }
