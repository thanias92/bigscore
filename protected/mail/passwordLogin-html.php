...
<body style="font-family: Arial, sans-serif; background-color: #f4f4f4; padding: 20px;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #fff; padding: 20px; border-radius: 5px; box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1);">
        <h2 style="text-align: center; color: #333;">OTP Login Mobile Satu Kantor</h2>
        <p>Hello <?= $user->username ?>,</p>
        <p>Kami menerima permintaan untuk login aplikasi Mobile Satu Kantor Anda. Berikut adalah kode OTP untuk melakukan login Anda:</p>
