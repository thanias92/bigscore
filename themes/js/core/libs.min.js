...
!(function (e, t) {
  ...
  (function (e, t) {
    ...
    const Jn = ".bs.tab",
      ...
      hr = `.nav-link${dr}, .list-group-item${dr}, [role="tab"]${dr}, ${fr}`,
      pr = `.${lr}[data-bs-toggle="tab"], .${lr}[data-bs-toggle="pill"], .${lr}[data-bs-toggle="list"]`;
    class gr extends q {
      constructor(e) {
        super(e),
      ...
      _keydown(e) {
        ...
        n && (n.focus({ preventScroll: !0 }), gr.getOrCreateInstance(n).show());
      }
      _getChildren() {
        return z.find(hr, this._parent);
      }
      _getActiveElem() {
      ...
      _getInnerElement(e) {
        return e.matches(hr) ? e : z.findOne(hr, e);
      }
      _getOuterElement(e) {
    ...
    F.on(document, Zn, fr, function (e) {
      ["A", "AREA"].includes(this.tagName) && e.preventDefault(),
        u(this) || gr.getOrCreateInstance(this).show();
    }),
      F.on(window, tr, () => {
        for (const e of z.find(pr)) gr.getOrCreateInstance(e);
      }),
      v(gr);
    const mr = ".bs.toast",
      vr = `mouseover${mr}`,
      ...
      kr = { animation: !0, autohide: !0, delay: 5e3 };
    class Lr extends q {
      constructor(e, t) {
        super(e, t),
          (this._timeout = null),
      ...
      show() {
        F.trigger(this._element, Sr).defaultPrevented ||
          (this._clearTimeout(),
      ...
      hide() {
        this.isShown() &&
          (F.trigger(this._element, wr).defaultPrevented ||
      ...
      _setListeners() {
        F.on(this._element, vr, (e) => this._onInteraction(e, !0)),
          F.on(this._element, yr, (e) => this._onInteraction(e, !1)),
          F.on(this._element, br, (e) => this._onInteraction(e, !0)),
          F.on(this._element, _r, (e) => this._onInteraction(e, !1));
      }
      _clearTimeout() {
